sap.ui.define([
	"sap/ui/test/Opa5",
	"com/comparisonpattern/Test_ComparisonPattern/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.comparisonpattern.Test_ComparisonPattern.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.comparisonpattern.Test_ComparisonPattern",
					async: true
				},
				hash: oOptions.hash,

		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ComparisonPattern-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ComparisonPattern-display": {
								"semanticObject": "ComparisonPattern",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.comparisonpattern.Test_ComparisonPattern",
									"url": sap.ui.require.toUrl("com/comparisonpattern/Test_ComparisonPattern")
								}
							}
						}
					}
